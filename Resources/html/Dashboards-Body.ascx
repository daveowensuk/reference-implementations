...
<%@ Register TagPrefix="ss1" Namespace="Izenda.Web.UI.Slider" Assembly="Izenda.AdHoc" %>
	...
	<div id="dashboardsDiv" class="report-page">
		...
		<form id="form1" runat="server">
			...
			<div class="btn-toolbar" style="margin: 4px 8px; z-index: 6; position: relative; float:left; margin: 12px 10px 4px 8px; white-space: nowrap;">
				<div class="btn-group">
			...
			<div style="position: relative; float:left; z-index: 6; margin: 13px 0 0 8px; white-space: nowrap;">
				<label style="font-size: 13px;">Refresh Every:</label>
				<select id="refreshReportIntervals" style="font-size: 13px; width: 120px;"></select>
